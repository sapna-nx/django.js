...
class UrlsTestMixin(object):
    ...
    def test_simple_url(self):
        ...
        self.assertIn('djangojs:urls', self.result)
        self.assertEqual(self.result['djangojs:urls'], '/djangojs/urls.json')
    ...
    def test_unnamed_url(self):
        ...
        self.assertNotIn('tests.testproject.urls.unnamed', self.result)
    ...
    @override_settings(JS_URLS=['djangojs:urls'])
    ...
    @override_settings(JS_URLS_EXCLUDE=['djangojs:urls'])
    def test_urls_blacklist(self):
        '''Should exclude urls listed in JS_URLS_EXCLUDE'''
        self.result = self.get_result()  # To take override_settings in account
        self.assertNotIn('djangojs:urls', self.result)
        self.assertIn('test_arg', self.result)
    ...
    @override_settings(JS_URLS_NAMESPACES=['djangojs'])
    def test_urls_app_name_whitelist(self):
        '''Should only include app_names listed in JS_URLS_NAMESPACES'''
        self.result = self.get_result()  # To take override_settings in account
        self.assertIn('djangojs:urls', self.result)

    @override_settings(JS_URLS_NAMESPACES_EXCLUDE=['djangojs'])
    def test_urls_app_name_blacklist(self):
        '''Should exclude app_names listed in JS_URLS_NAMESPACES_EXCLUDE'''
        self.result = self.get_result()  # To take override_settings in account
        self.assertNotIn('djangojs:urls', self.result)

    @override_settings(JS_URLS_NAMESPACES=['djangojs', 'django-js'])
    def test_urls_namespace_and_app_name_whitelist(self):
        '''Should only include app_names listed in JS_URLS_NAMESPACES'''
        self.result = self.get_result()  # To take override_settings in account
        self.assertIn('djangojs:urls', self.result)
        self.assertIn('django-js:urls', self.result)

    @override_settings(JS_URLS_NAMESPACES_EXCLUDE=['djangojs', 'django-js'])
    def test_urls_namespace_and_app_name_blacklist(self):
        '''Should exclude app_names listed in JS_URLS_NAMESPACES_EXCLUDE'''
        self.result = self.get_result()  # To take override_settings in account
        self.assertNotIn('djangojs:urls', self.result)
        self.assertNotIn('django-js:urls', self.result)
    ...
    def test_force_script_name(self):
        ...
        self.assertEqual(self.result['djangojs:urls'], '/force_script/djangojs/urls.json')
...
class UrlsJsonViewTest(UrlsTestMixin, TestCase):
    ...
    def get_result(self):
        self.response = self.client.get(reverse('djangojs:urls'))
    ...
    def test_force_script_name(self):
        ...
        self.assertEqual(result['djangojs:urls'], '/force_script/djangojs/urls.json')
